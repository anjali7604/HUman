...
##WALKING TRAIN
x, y, z = np.loadtxt('walkingtrain.csv',delimiter =',',unpack =True)
...
for i ,val in enumerate(valmean):
    saveFile = open ('unnormal_features_walking_train.csv','a')
...
x, y, z = np.loadtxt('walkingtest.csv',delimiter =',',unpack =True)
...
for i ,val in enumerate(valmean):
    saveFile = open ('unnormal_features_walking_test.csv','a')
    saveFile.write(str(valmean[i]) + ',' +str(valmax[i]) + ',' + str(valmin[i]) + ',' + str(valstd[i]) + ',' + str(valenergy[i])+','+ str(energy_signal[i]) + ',' + str(0) )
    saveFile.write('\n')
...
##SITTING TRAIN
x, y, z = np.loadtxt('sittingtrain.csv',delimiter =',',unpack =True)
...
for i ,val in enumerate(valmean):
    saveFile = open ('unnormal_features_sitting_train.csv','a')
    saveFile.write(str(valmean[i]) + ',' +str(valmax[i]) + ',' + str(valmin[i]) + ',' + str(valstd[i]) + ',' + str(valenergy[i])+','+ str(energy_signal[i]) + ',' + str(1) )
    saveFile.write('\n')
...
x, y, z = np.loadtxt('sittingtest.csv',delimiter =',',unpack =True)
...
for i ,val in enumerate(valmean):
    saveFile = open ('unnormal_features_sitting_test.csv','a')
    saveFile.write(str(valmean[i]) + ',' +str(valmax[i]) + ',' + str(valmin[i]) + ',' + str(valstd[i]) + ',' + str(valenergy[i])+','+ str(energy_signal[i]) + ',' + str(1) )
    saveFile.write('\n')
